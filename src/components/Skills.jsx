...
//             className={`${group.bgColor} border border-gray-200 dark:border-gray-700 rounded-2xl shadow-md hover:shadow-xl transition-shadow p-6 text-center`}
//           >
...
//           className={`${skillGroups[3].bgColor} border border-gray-200 dark:border-gray-700 rounded-2xl shadow-md hover:shadow-xl transition-shadow p-6 text-center`}
//         >
//           <h3 className="text-2xl font-semibold mb-4 text-indigo-700 dark:text-indigo-400">
//             {skillGroups[3].title}
//           </h3>
